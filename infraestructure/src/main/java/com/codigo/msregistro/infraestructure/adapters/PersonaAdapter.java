...
public class PersonaAdapter implements PersonaServiceOut {
    ...
    private Timestamp getTimeStamp(){
        long currentTime = System.currentTimeMillis();//Capturar fecha y hora del sistema en milisegundos
        Timestamp timestamp = new Timestamp(currentTime);//Lo traducimos en un timestamp
        return timestamp;
    }

    @Override
    public Optional<PersonaDTO> obtenerPersonaoOut(Long id) {
